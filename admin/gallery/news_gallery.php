     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/gallery/news_add.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                   ...
                   <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
                     ...
                     <thead>
                       ...
                       <tr>
                         ...
                         <td class="text-left text-info">news Gallery Image</td>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `news_gallery` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , where id=$id";
