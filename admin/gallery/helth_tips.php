     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <ul class="breadcrumb">
              ...
              <li><a href="<?php echo $base_path;?>admin/gallery/helth_tips.php">helth_tips</a></li>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `helth_tips` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , department=\"$department\" where id=$id";
