     ...
     <div id="content">
        ...
        <div class="container-fluid">
           ...
           <div class="panel panel-default">
              ...
              <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-pencil"></i> <?php if(isset($_REQUEST['edit'])){echo 'Edit';}else{echo 'Add';}?> Helth Tips</h3></div>
                    ...
                    <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                       {
...

                          {
                             ...
                             $sql  = "INSERT INTO `helth_tips` (`id`, `gallery_image`, `image_caption`, `description`, `category`,  `date_added`)
                             ...
                             {?>
                                ...
                                <div class="alert alert-success alert-dismissible" role="alert" style="margin-bottom: 20px;">
                                   ...
                                   <strong>Success !</strong>   Helth Tips image Successfully added to website.
