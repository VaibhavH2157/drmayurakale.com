                   ...
                   <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
                     ...
                     <thead>
                       ...
                       <tr>
                         ...
                         <td class="text-left text-info">status</td>
<!-- 
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <?php 
                                    if($row['status'] == "1")
                                    {?>
                                       <a href="<?php $base_path;?>admin/feedback/active.php?id=<?php echo $row['id'];?>"class="btn btn-primary">Enable</a>
                                    <?php } else { ?>
                                    
                                       <a href="<?php $base_path;?>admin/feedback/deactive.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Disable</a>
