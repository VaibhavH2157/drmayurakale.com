  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
          ...
          <a href="<?php echo $base_path;?>admin/feedback/add-patient-reviews-submit.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>
      ...
      <ul class="breadcrumb">
                ...
                <li><a href="<?php echo $base_path;?>admin/feedback/add-patient-reviews-submit.php">Feedback List</a></li>
                  ...
                  ?>
                   ...
                   <tr>
                       ...
                       <td class="text-right">
                         ...
                         <a href="<?php $base_path;?>admin/feedback/patient-reviews-submit.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                         <a href="<?php $base_path;?>admin/feedback/patient-reviews-submit.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
...
//Edit form action statrs from here
    ...
    <?php        
                ...
                if(isset($_POST['edit']))
                {
                 ...
                 extract($post);
                  ...
                  $sql  = "update `feedback` set `name`=\"$fname\",`feedback`=\"$feedback\"
                 where id=$id";
...

                     {
                       ...
                       ?>
                         ...
                         <div class="alert alert-success alert-dismissible" role="alert" style="margin-bottom: 20px;">
                           ...
                           <strong>Success !</strong>  Feedback Successfully updated.
   ...
   <div class="form-group">
     <label class="control-label col-sm-2" for="	photo">Feedback:</label>
  
      <div class="col-sm-10">
         
         <textarea type="text" class="form-control" rows="7" name="feedback" value="<?=$feedback?>" id="feedback" placeholder="feedback"></textarea>
      </div>
                          ...
                          if($res)
                          {
                              ...
                              ?>
                               ...
                               <div class="alert alert-success alert-dismissible" role="alert" style="margin-bottom: 20px;">
                                 ...
                                 <strong>Success !</strong>  Feedback Successfully removed from website.
