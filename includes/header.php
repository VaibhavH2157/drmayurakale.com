...
<head>
  ...
  <!-- Favicons -->
  <link href="img\Photos\kale_logo.jpg" rel="icon">
...
<div class="container">
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top ">
    ...
    <?php
			...
			if($num>0)
			{
				...
				?><marquee class="text-dark mt-2"style="font-weight:bold;  font-size: 15px; color:blue;" behavior="scroll" scrollamount="7" direction="left"><?=$notify_text?></marquee></a> <?php 
					// }
			}
		?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo me-auto"><a href="index.html">KaleClinic</a></h1> -->
      <h1 class=" logo me-auto  d-inline-block"><a href="index.php" ><img src="img\Photos\kale_logo.jpg" alt="">DR MAYURA KALE</a></h1>
